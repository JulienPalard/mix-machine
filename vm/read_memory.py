...
# than goes any number of lines like "xxxx +/-1 xx xx xx xx xx [comment]" or
# empty lines


def parse_word(line):
    """
    Returns tuple of word index and list like [+1, 0, 0, 0, 0, 0] or
    None if empty line
    """
            ...
            if res is None:
                ...
                if res[0] in memory:
                    ...
                    if Word.is_word_list(res[1]):
                        ...
                        errors.append((i + 1,
                                       InvalidMixWordError(tuple(res[1]))))
